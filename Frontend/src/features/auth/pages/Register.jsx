      ...
      <div className="auth-center-card">
        ...
        <form className="auth-form" id="register-form">
          ...
          <p className="auth-terms">
            ...
            <a href="#" className="auth-link" id="reg-terms-link">Terms of Service</a>{" "}
            and{" "}
            <a href="#" className="auth-link" id="reg-privacy-link">Privacy Policy</a>.
          </p>

          {/* Submit */}
          <button className="auth-submit-btn" type="submit" id="register-submit-btn">
            Create Account
          </button>
        ...
        <p className="auth-switch">
          ...
          <Link to="/auth/login" className="auth-link" id="go-to-login">Sign in</Link>
        </p>
