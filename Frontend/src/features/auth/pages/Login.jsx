  ...
  return (
    <div className="auth-center-root">
      <div className="auth-center-card">
        ...
        {/* Logo */}
        <Link to="/home" className="auth-center-logo" id="login-logo">
          <span>●</span>LUXE
        </Link>
        ...
        <div className="auth-header">
          ...
          <p className="auth-subtitle">
            Access your orders, wishlist, and exclusive member deals.
          </p>
        </div>
        ...
        <form className="auth-form" id="login-form">
          ...
          <div className="auth-options">
            ...
            <a href="#" className="auth-link" id="forgot-password-link">Forgot password?</a>
          </div>

          {/* Submit */}
          <button className="auth-submit-btn" type="submit" id="login-submit-btn">
            Sign In
          </button>
        ...
        <p className="auth-switch">
          ...
          <Link to="/auth/register" className="auth-link" id="go-to-register">Create one</Link>
        </p>
