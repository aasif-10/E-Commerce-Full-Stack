      ...
      <div className="auth-center-card">
        ...
        <form className="auth-form" id="login-form" onSubmit={handleSubmit}>
          ...
          <div className="auth-options">
            ...
            <a href="#" className="auth-link" id="forgot-password-link">
              Forgot password?
            </a>
          </div>
          ...
          >
            {loading ? (
              <>
                ...
                <span className="auth-btn-label">Signing in…</span>
              </>
            ) : (
        ...
        <p className="auth-switch">
          ...
          <Link to="/auth/register" className="auth-link" id="go-to-register">
            Create one
          </Link>
        </p>
      </div>
