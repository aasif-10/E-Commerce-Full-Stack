      ...
      <div className="checkout-layout">
        ...
        <div>
          ...
          <div className="checkout-section">
            ...
            <div className="checkout-form">
              <div className="field-row">
                <div className="field">
                  <label className="input-label" htmlFor="co-name">Full Name</label>
                  <input id="co-name" className="input" type="text" placeholder="John Doe" />
                </div>
                <div className="field">
                  <label className="input-label" htmlFor="co-email">Email</label>
                  <input id="co-email" className="input" type="email" placeholder="your@email.com" />
                </div>
              </div>
              <div className="field">
                <label className="input-label" htmlFor="co-phone">Phone (optional)</label>
                <input id="co-phone" className="input" type="tel" placeholder="+1 (555) 000-0000" />
              </div>
            </div>
          </div>
          ...
          <div className="checkout-section">
            ...
            <div className="checkout-form">
              <div className="field">
                <label className="input-label" htmlFor="co-address">Street Address</label>
                <input id="co-address" className="input" type="text" placeholder="123 Main Street" />
              </div>
              <div className="field">
                <label className="input-label" htmlFor="co-address2">Apartment, suite, etc. (optional)</label>
                <input id="co-address2" className="input" type="text" placeholder="Apt 4B" />
              </div>
              <div className="field-row">
                <div className="field">
                  <label className="input-label" htmlFor="co-city">City</label>
                  <input id="co-city" className="input" type="text" placeholder="New York" />
                </div>
                <div className="field">
                  <label className="input-label" htmlFor="co-zip">ZIP / Postal Code</label>
                  <input id="co-zip" className="input" type="text" placeholder="10001" />
                </div>
              </div>
              <div className="field-row">
                <div className="field">
                  <label className="input-label" htmlFor="co-state">State / Province</label>
                  <input id="co-state" className="input" type="text" placeholder="New York" />
                </div>
                <div className="field">
                  <label className="input-label" htmlFor="co-country">Country</label>
          ...
          <div className="checkout-section">
            ...
            <div className="checkout-payment-opts" style={{ marginBottom: 20 }}>
              ...
              <label className="pay-option" id="pay-paypal">
                ...
                <div>
                  ...
                  <p className="pay-option-sub">Pay via PayPal balance or card</p>
                </div>
            ...
            <div className="checkout-form">
              <div className="field">
                <label className="input-label" htmlFor="co-card-name">Name on Card</label>
                <input id="co-card-name" className="input" type="text" placeholder="John Doe" />
              </div>
              <div className="field">
                <label className="input-label" htmlFor="co-card-number">Card Number</label>
                <input id="co-card-number" className="input" type="text" placeholder="1234 5678 9012 3456" maxLength={19} />
              </div>
              <div className="field-row">
                <div className="field">
                  <label className="input-label" htmlFor="co-card-expiry">Expiry Date</label>
                  <input id="co-card-expiry" className="input" type="text" placeholder="MM / YY" maxLength={7} />
                </div>
                <div className="field">
                  <label className="input-label" htmlFor="co-card-cvc">CVC</label>
                  <input id="co-card-cvc" className="input" type="text" placeholder="123" maxLength={4} />
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="checkout-summary">
          ...
          {MINI_ITEMS.map((item) => (
            <div className="checkout-mini-item" key={item.id}>
              ...
              <div className="checkout-mini-info">
                <p className="checkout-mini-name">{item.name}</p>
                <p className="checkout-mini-meta">{item.meta}</p>
              </div>
              <span className="checkout-mini-price">{item.price}</span>
            </div>
          ))}
          ...
          <Link to="/cart" style={{ display: "block", marginTop: 16 }}>
            <button className="btn btn-ghost btn-full btn-sm" id="back-to-cart-btn">← Back to Cart</button>
          </Link>
        </div>
