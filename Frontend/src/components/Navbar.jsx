    ...
    <nav className="nav">
      <div className="nav-inner">
        ...
        <ul className="nav-links">
          <li><NavLink to="/products" id="nav-products">Shop</NavLink></li>
          <li><NavLink to="/orders" id="nav-orders">Orders</NavLink></li>
        </ul>
        ...
        <div className="nav-actions">
          ...
          <Link to="/checkout">
            <button className="nav-btn" id="nav-checkout-btn">Checkout</button>
          </Link>
        </div>
